        ...
        <div class="card">
          <div class="flip-card">
            <div class="flip-card__container">
              ...
              <div class="card-back">
                <img class="video__container" src="../assets/img/javascript.jpg" >
        ...
        <div class="card">
          <div class="flip-card">
            <div class="flip-card__container">
              ...
              <div class="card-back">
                <img class="video__container" src="../assets/img/html.png" >
          ...
          <div class="inside-page">
            <div class="inside-page__container">
              ...
              <a href="#" class="inside-page__btn ">Masuk Kelas</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="card">
          <div class="flip-card">
            <div class="flip-card__container">
              ...
              <div class="card-back">
                <img class="video__container" src="../assets/img/node.jpg" >
        ...
        <div class="card">
          <div class="flip-card">
            <div class="flip-card__container">
              ...
              <div class="card-back">
                <img class="video__container" src="../assets/img/nuxt.png" >
