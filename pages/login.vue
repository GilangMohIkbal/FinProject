<template>
    <div class="mt-5">
        <section class="h-120 w-100" style="box-sizing: border-box; background-color: #f5f5f5">
      ...
      <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
        <div class="right mx-lg-0 mx-auto">
          ...
          <h3 class="title-text">Log In</h3>
          <p class="caption-text">
            email : register@gmail.com<br />
            Password : password
          </p>
          <form style="margin-top: 1.5rem" action="" method="post" @submit.prevent="login">
            <div style="margin-bottom: 1.75rem">
              ...
              <div class="d-flex w-100 div-input">
                ...
                <input class="input-field border-0" type="email" v-model="email" name="" id="" placeholder="Your Email Address"
            ...
            <div style="margin-top: 1rem">
              ...
              <div class="d-flex w-100 div-input">
                ...
                <input class="input-field border-0" type="password" name="" id="password-content-3-5" v-model="password"
